...
In addtion, one example tutorial is online available which gives you an idea about the tutorial of the book. The *base R* tutorial accompanies the second chapter of Practice and discusses typical errors (new) R users need to face. 


Find the links to the sample pages and the tutorial below.

<br>
<a class="edgar" align="right" href="#">Download sample</a>
