...
-   `r copycat::copycat_description("utils", "install.packages")` (`install.packages`)

-   `r copycat::copycat_description("base", "library")` (`library`)

-   Inspect the help file (`?function`)

-   `r copycat::copycat_description("base", "c")` (`c`)

-   Compare objects (`<=, >=, ==, !=`)

-   `r copycat::copycat_description("base", "rep")` (`rep`)

-   `r copycat::copycat_description("base", "seq")` (`seq`)

-   `r copycat::copycat_description("base", "sum")` (`sum`)

-   `r copycat::copycat_description("base", "length")` (`length`)

-   `r copycat::copycat_description("base", "class")` (`class`)

-   `r copycat::copycat_description("base", "data.frame")` (`data.frame`)

-   `r copycat::copycat_description("tibble", "tibble")` [`tibble::tibble`, @tibble]

-   `r copycat::copycat_description("tibble", "tribble")`(`tibble::tribble`)

-   `r copycat::copycat_description("base", "nrow")` (`nrow`/`ncol`)
