...
description: >
  Explore common and cryptic error messages from base R.
...
[![Debugging: Artwork by Allison Horst](images/debug2.png){width="90%"}](https://allisonhorst.com/everything-else)
'`
...
```{r, echo=FALSE, eval=T}
actionButton("download", "PR Tutorial 02", onclick="window.open('https://github.com/edgar-treischl/Scripts_PracticeR/raw/main/tutorials/PracticeR_Tutorial2.pdf')", icon = icon("file-pdf"))
```
