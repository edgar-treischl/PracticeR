...
```{r, echo=FALSE, eval=T}
actionButton("download", "PR Tutorial 02", onclick="window.open('https://github.com/edgar-treischl/Scripts_PracticeR/raw/main/tutorials/PracticeR_Tutorial07.pdf')", icon = icon("file-pdf"))
```
