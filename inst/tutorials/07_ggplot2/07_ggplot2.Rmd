...
```{r r6, exercise=TRUE, exercise.setup = "r5", exercise.lines = 3}
...
```{r r7, exercise=TRUE, exercise.setup = "r5", exercise.lines = 7}
...
```{r r8, tidy=FALSE, exercise=TRUE, exercise.setup = "r7", exercise.lines = 19}
