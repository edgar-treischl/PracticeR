...
[![Artwork by Jake Clark](images/meme.png){width="50%"}](https://www.youtube.com/watch?v=0J8c3nDms7w)
'`
...
```{r, echo=FALSE, eval=T}
actionButton("download", "PR Tutorial 04", onclick="window.open('https://github.com/rstudio/cheatsheets/blob/main/base-r.pdf')", icon = icon("file-pdf"))
```
