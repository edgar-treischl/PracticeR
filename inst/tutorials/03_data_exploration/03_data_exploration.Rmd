...
[![Palmerpenguins: Artwork by \@allison_horst](images/penguins.png){width="90%"}](https://allisonhorst.github.io/palmerpenguins/index.html)
...
```{r r7, exercise=TRUE, exercise.setup = "r6"}
#Create a barplot
...
```{r, echo=FALSE, eval=T}
actionButton("download", "PR Tutorial 03", onclick="window.open('https://github.com/rstudio/cheatsheets/blob/main/base-r.pdf')", icon = icon("file-pdf"))
```
